...
function install(basePath, fileNames) {
    return __awaiter(this, void 0, void 0, function* () {
        const { name: outDir } = config_1.RootLauncherConfig;
        ...
        const createdMsg = config_1.RootLauncherConfig.isCurrentFolder
            ? `\n\n${fileNames.length} files created in the current directory`
            : `\n\n${fileNames.length} files created in ${(0, chalk_1.dim)(`./${outDir}`)} directory`;
        const bootStrapMsg = config_1.RootLauncherConfig.isCurrentFolder
...
class MakeInstall {
    static install(basePath) {
        return __awaiter(this, void 0, void 0, function* () {
            let mainClass;
            const { template } = config_1.RootLauncherConfig;
